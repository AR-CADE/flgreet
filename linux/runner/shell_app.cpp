...
void ShellApp::on_shutdown() { rem_all_monitor(); }
...
static const char *get_version_string() { return "1.0.0"; }
...
ShellApp &ShellApp::get() { return *instance; }

void ShellApp::run() { app->run(); }
